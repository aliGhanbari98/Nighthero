...
export const useStyle = makeStyles(theme => ({
  container: {
    ...
    '& > .body': {
      ...
      '& > .bookingMethodSection': {
        ...
        alignItems: 'start',
        padding: 15,
        cursor: ({ bookingSectionDisabled }) =>
          bookingSectionDisabled ? 'not-allowed' : 'pointer',
        opacity: ({ step }) => (step === 2 ? 1 : 0.3),
        '& > span': {
          padding: '5px 0',
          fontSize: 16,
          fontWeight: 'bold',
  ...
  detailsCard: {
    ...
    left: ({ selectedOfferWidth }) => Number(selectedOfferWidth) + 35,
    top: '50%',
